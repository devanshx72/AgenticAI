...
import pandas as pd
import pickle
# install scikit-learn==1.6.1 also
...
class UserInput(BaseModel):
    ...
    city: Annotated[int, Field(..., description="The city that the user belongs to")]
...
def predict_premium(data: UserInput) -> str:
    ...
    return JSONResponse(status_code=200, content={'predicted_output': pred})
